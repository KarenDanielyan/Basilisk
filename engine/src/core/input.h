...
void input_init();
void input_shutdown();
void input_update(f64 delta_t);

// Keyboard input
BAPI b8 input_key_down(keys key);
BAPI b8 input_key_up(keys key);
BAPI b8 input_key_was_down(keys key);
BAPI b8 input_key_was_up(keys key);

void input_process_key(keys key, b8 pressed);

// Mouse input
BAPI b8 input_mouse_down(buttons button);
BAPI b8 input_mouse_up(buttons button);
BAPI b8 input_mouse_was_down(buttons button);
BAPI b8 input_mouse_was_up(buttons button);
BAPI void input_mouse_position(i32 *x, i32 *y);
BAPI void input_mouse_previous_position(i32 *x, i32 *y);

void input_process_mouse(buttons button, b8 pressed);
