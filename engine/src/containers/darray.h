...
// NOTE: could use _auto_type for _value above, but intellisense
// for VSCore flags it as an unknown type. typedef() seems to 
// work just fine, though, both are GNU clang extensions.
